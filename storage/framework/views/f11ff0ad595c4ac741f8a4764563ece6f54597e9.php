	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?php echo e(route('galery')); ?>">Galeria</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo e(route('abouts')); ?>">About</a>
				</li>
			</ul>
			<form>
...
</html><?php /**PATH /Users/mago_jefer/Documents/GitHub/radioinempopayan/resources/views/base.blade.php ENDPATH**/ ?>